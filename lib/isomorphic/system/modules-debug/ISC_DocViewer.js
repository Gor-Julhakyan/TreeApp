...
,isc.A.linkForRef=function isc_c_DocUtils_linkForRef(ref,name,linkRef,skipParens,baseTypeMode){
    ...
    if(!docItem){
        if(ref.startsWith("method:")||ref.startsWith("classMethod:")||
...
isc.A._$jsStaticMethod="staticMethod";
isc.A._$jsAttr="attr";
...
isc.A._methodsOnly=["method","classMethod","staticMethod"];
isc.A._methodsAndAttrs=["attr","method","classAttr","classMethod","staticMethod"];
...
,isc.A.hoverHTML=function isc_c_JSDoc_hoverHTML(container,item,linkName){
    ...
    if(docItem.constant)return null;
...
,isc.A.getInheritedDocItems=function isc_ClassViewer_getInheritedDocItems(type){
    ...
    if(type=="classAttrs"){
        ...
        items=items.filter(function(item){
            ...
            return!docItem||!docItem.constant
        });
    }
...
isc.B.push(isc.A.initWidget=function isc_DocViewer_initWidget(){
    if(window.docItem)isc.jsdoc.init(window.docItems);
...
,isc.A._doSelect=function isc_DocViewer__doSelect(classViewer,ref,viewRef){
    ...
    if(!(isc.jsdoc.isMethod(docItemType)||isc.jsdoc.isAttr(docItemType))){
        ...
        var tab=0;
        if(this.state.data.tabs)tab=this.state.data.tabs[id]||0;
